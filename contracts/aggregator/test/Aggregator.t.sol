...
//    }
    ...
    function test_UniswapV2ExactOutPayToSelf_UniswapV2ExactOutPayToSender_BalancerWeightedExactOut() public {
        ...
        bytes memory data = hex"0e000000012e8135be71230c6b1b4045696d41c09db04142260c68155a43676e000020000169d91b94f0aaf8e8a2586909fa77a5c2c89818d50603228400002000009e0905249ceefffb9605e034b534544684a58be6080e21359700000080c02aaa39b223fe8d0a0e5c4f27ead9083c756cc20c6b7d62e0264f";
        (bool success, bytes memory res) = address(agg).call(data);
        require(success);
